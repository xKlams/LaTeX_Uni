...
\newenvironment{congettura}
{\begin{mdframed}[linecolor=green, backgroundcolor=green!10]\begin{conge}}
{\end{conge}\end{mdframed}}
...
\newenvironment{ass}
{\begin{mdframed}[linecolor=orange, backgroundcolor=orange!10]\begin{assio}}
  {\end{assio}\end{mdframed}}
...
\newcommand{\Le}{\mathbb{Le}}
\newcommand{\pro}{\mathbb{P}}
\newcommand{\bigslant}[2]{{\raisebox{.2em}{$#1$}\left/\raisebox{-.2em}{$#2$}\right.}}
\newcommand{\diff}[2]{\frac{d #1}{d #2}}
\newcommand{\normale}{\trianglelefteq}
\newcommand{\pene}{\text{8==========================================D}}
\newcommand{\semi}{\rtimes_{\o}}
\newcommand{\agisce}{\curvearrowright}
